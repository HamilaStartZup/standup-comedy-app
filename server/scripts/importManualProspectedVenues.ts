...
const MANUAL_VENUES: ProspectionSearchResult[] = [
  ...
  },
  {
    ...
    type: 'autre',
    email: null,
    phone: normalizePhoneFR('06 95 64 97 37'),
    address: {
      street: '36 rue Dalayrac',
      city: 'Paris',
      postalCode: '75002',
      departement: '75',
      departementName: FRENCH_DEPARTMENTS['75'],
  ...
  {
    name: "Centre Paris Anim' Dunois (Atelier Stand-Up)",
    type: 'centre_culturel',
    email: 'contact.dunois.paris@ifac.asso.fr',
    phone: normalizePhoneFR('01 45 83 44 36'),
    address: {
      street: 'Dunois',
      city: 'Paris',
      postalCode: '75013',
  ...
  {
    name: "Centre Paris Anim' Censier (Stand Up Comedy)",
    type: 'centre_culturel',
    email: 'cacensier@actisce.org',
    phone: normalizePhoneFR('01 43 37 40 92'),
    address: {
      street: '12, rue Censier',
      city: 'Paris',
      postalCode: '75005',
      departement: '75',
      departementName: FRENCH_DEPARTMENTS['75'],
  ...
  },
  {
    ...
    type: 'salle_spectacle',
    email: 'groupes@comediedeparis.com',
    phone: normalizePhoneFR('01 42 81 00 11'),
    address: {
      street: '42 rue Pierre Fontaine',
      city: 'Paris',
      postalCode: '75009',
      departement: '75',
      departementName: FRENCH_DEPARTMENTS['75'],
  ...
  {
    name: 'Studio des Champs Élysée',
    type: 'salle_spectacle',
    email: 'contact@comediedeschampselysees.com',
    phone: normalizePhoneFR('01 53 23 99 10'),
    address: {
      street: '15 Av. Montaigne',
      city: 'Paris',
      postalCode: '75008',
      departement: '75',
      departementName: FRENCH_DEPARTMENTS['75'],
  ...
  {
    name: 'Paris Stand-Up School (école de stand-up)',
    type: 'autre',
    email: 'paris.standup.school@gmail.com',
    phone: null,
    address: {
      city: 'Paris',
      departement: '75',
  ...
  },
  {
    ...
    type: 'autre',
    email: 'renseignement@lafermecomedy.club',
    phone: normalizePhoneFR('01 80 05 26 00'),
    address: {
  ...
  {
    name: 'Chez Prince (Odéon)',
    type: 'autre',
    email: 'chezprinceparis@gmail.com',
    phone: normalizePhoneFR('01 43 26 60 60'),
    address: {
      street: 'Odéon',
      city: 'Paris',
      postalCode: '75006',
  ...
  },
  {
    name: 'Micro Plié',
    type: 'autre',
    email: 'micoplieparis@gmail.com',
    phone: normalizePhoneFR('01 42 36 11 11'),
    address: {
      street: 'Châtelet',
      city: 'Paris',
      postalCode: '75001',
  ...
  },
  {
    ...
    type: 'autre',
    email: 'cartelcomedyclub@gmail.com',
    phone: null,
    address: {
      street: '6 Rue de la Tacherie',
      city: 'Paris',
      postalCode: '75004',
      departement: '75',
      departementName: FRENCH_DEPARTMENTS['75'],
  ...
  },
  {
    name: 'Le Big Show',
    type: 'autre',
    email: 'lebigshowcomedyclub@gmail.com',
    phone: null,
    address: {
      street: '6 rue Frochot',
      city: 'Paris',
      postalCode: '75009',
      departement: '75',
      departementName: FRENCH_DEPARTMENTS['75'],
  ...
  },
  {
    name: 'Le Don K',
    type: 'autre',
    email: 'donkcomedyclub@gmail.com',
    phone: null,
    address: {
      street: '10 Rue des Saints-Pères',
      city: 'Paris',
      postalCode: '75007',
      departement: '75',
      departementName: FRENCH_DEPARTMENTS['75'],
  ...
  },
  {
    name: 'Le Café Oscar',
    type: 'autre',
    email: 'cafeoscarnight@gmail.com',
    phone: null,
    address: {
      street: '155 rue Montmartre',
      city: 'Paris',
      postalCode: '75002',
      departement: '75',
      departementName: FRENCH_DEPARTMENTS['75'],
  ...
  },
  {
    ...
    type: 'autre',
    email: 'lascenebarbes@gmail.com',
    phone: normalizePhoneFR('01 42 51 14 80'),
    address: {
      street: '39 rue Léon',
      city: 'Paris',
      postalCode: '75018',
  ...
  {
    name: "Leatre Olivier (L'Olivier)",
    type: 'theatre',
    email: null,
    phone: normalizePhoneFR('01 43 57 55 55'),
    address: {
      street: '115 rue du Chemin Vert',
      city: 'Paris',
      postalCode: '75011',
      departement: '75',
      departementName: FRENCH_DEPARTMENTS['75'],
  ...
  },
  {
    ...
    type: 'salle_spectacle',
    email: null,
    phone: normalizePhoneFR('01 42 60 40 11'),
    address: {
      street: '40 rue Berger',
      city: 'Paris',
      postalCode: '75001',
      departement: '75',
      departementName: FRENCH_DEPARTMENTS['75'],
  ...
  },
  {
    ...
    type: 'theatre',
    email: null,
    phone: normalizePhoneFR('01 42 78 67 03'),
    address: {
      street: '7 rue Sainte-Croix-de-la-Bretonnerie',
      city: 'Paris',
      postalCode: '75004',
      departement: '75',
      departementName: FRENCH_DEPARTMENTS['75'],
  ...
  {
    name: 'Théâtre de la Contrescarpe',
    type: 'theatre',
    email: 'billetterie@lecontrescarpe.com',
    phone: normalizePhoneFR('01 42 01 81 88'),
    address: {
      street: '13 rue du Pot de Fer',
      city: 'Paris',
      postalCode: '75005',
      departement: '75',
      departementName: FRENCH_DEPARTMENTS['75'],
    },
    website: 'https://www.lecontrescarpe.com',
    source: 'manuel',
  },
  {
    name: 'Le Trempoint',
    type: 'autre',
    email: 'artistique@lepointvirgule.com',
    phone: normalizePhoneFR('01 42 36 11 11'),
    address: {
      street: '7 rue Sainte-Croix-de-la-Bretonnerie',
      city: 'Paris',
  ...
  },
  {
    ...
    type: 'autre',
    email: 'contact@quartierdelagare.fr',
    phone: normalizePhoneFR('01 81 87 34 92'),
    address: {
      street: '50 avenue Carnot',
      city: 'Massy',
